...
int CTurorialsTest::mRun_GenericTutorial()
{
	...
	std::cout << "- [3] typedef & enum \n";
	std::cout << "- [4] typedef & enum \n";
	std::cout << "- [5] typedef & enum \n";
...
int CTurorialsTest::mRun_CiscoTests()
{
  ...
  /* the two numbers */
	...
	std::cout << " =============================\n";
	std::cout << "- [1] Arithmetics \n";
	std::cout << "- [2] Control flow \n";
	std::cout << "- [3] opc \n";
	std::cout << "- [4] opc \n";
	std::cout << "- [5] opc \n";
	std::cout << "- [6] opc \n";
...
int main()
{
	...
	while (choice != 3) 
	{
		...
		std::cout << "- Run CISCO net academy code sample code (2)\n";
		std::cout << "- Quit \n";
